            ...
            <div id="Project" className="pt-10 pb-10 px-6 sm:px-12 md:px-20 lg:px-40 xl:px-80">
                <div className="flex flex-col w-full">
                    ...
                    <div className="flex justify-center flex-wrap pt-10 gap-10">
                        ...
                        <ProjectCard projTitle='3D Graphic Engine' imgLink={GraphicEngineImg} gitLink='https://github.com/jazwinn/Graphics-Engine' projDesc='Custom made 3D graphics engine in C++ build with OpenGL. Able to display simple shapes and models. Allows for point, spot and directional light.' />
