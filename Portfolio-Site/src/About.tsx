            ...
            <div id="About" className="pt-10 pb-10 px-80">
                <div className="flex w-full">
                    ...
                    <div className="flex flex-col justify-center text-white w-1/2 pl-4 pr-4 animate-slideInLeft">
                        ...
                        <p className="text-2xl text-[#c7c7c7] mb-5 font-semibold">Hello! I’m Jaz — a developer passionate about building software that is intuitive, efficient, and meaningful. I enjoy exploring new tools, improving my skills, and creating projects that challenge and inspire me.</p>
                    </div>
                </div>
                <div className="flex flex-col w-full pt-30">
                    <div className="flex justify-center">
                        <h1 className="text-white text-4xl font-bold font-Satoshi">My Tech Stack and Skills</h1>
                    </div>
                    <div className="flex justify-center flex-wrap pt-10 gap-10">
                        ...
                        <SkillCard title="Concepts" skills={["OOP", "DSA", "Spatial Data Structure", "Engine Architecture"]}/>
                    </div>
                </div>
            </div>
        </>
